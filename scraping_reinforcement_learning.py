...
url_file_name = "reinforcement_learning"
...
for article_i in range(N):
    ...
    try:
        ...
        try:
            ...
            # s3.
                s3.upload_file(json_file, 'scraping-impulso', 'reinforcement_learning_2879.json')
                s3.upload_file(output_file, 'scraping-impulso', 'reinforcement_learning_2879.csv')
